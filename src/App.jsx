        ...
        <tbody>
          <tr>
            ...
            <td className="meditation coming-in">
              ...
              <br />
              <br />
              <em>Effect:</em> Hearts opened to receive divine love and to give
              it to others.
            </td>
          </tr>
          <tr>
            ...
            <td className="meditation going-out">
              ...
              fear of people or the physical world. Focus on divine strength and
              boundaries - the ability to say 'no' to evil. <br />
              <br />
          ...
          <tr>
            ...
            <td className="meditation going-out">
              Raise Tiferet to its root in Da'at. Align with the beauty of Torah
              and mitzvot rather than seeking worldly approval. Focus on harmony
              between Chesed and Gevurah. <br />
              <br />
              <em>Mystical aspect:</em> The human realm (מה - "what?") seeking
              to understand divine beauty.
            </td>
            <td className="meditation coming-in">
              Bring light into Malchut, beautifying service to Hashem. Pray for
              spiritual renewal to shine on all Israel. <br />
              <br />
          ...
          <tr>
            ...
            <td className="meditation going-out">
              Raise Netzach to its root in Da'at. Focus on overcoming the yetzer
              hara and achieving victory in spiritual matters. Channel energy
              toward eternal goals. <br />
              <br />
              <em>Mystical aspect:</em> Victory corresponds to the right
              column's extension upward.
            </td>
            <td className="meditation coming-in">
              Bring light into Malchut, instilling perseverance and triumph over
              challenges. Pray for success in both spiritual and material
              endeavors. <br />
              <br />
          ...
          <tr>
            ...
            <td className="meditation going-out">
              Raise Hod to its root in Da'at. Cultivate gratitude to Hashem for
              His kindness, recognizing His gifts in every moment. Submit to
              divine will. <br />
              <br />
          ...
          <tr>
            ...
            <td className="meditation going-in">
              ...
              righteous individuals. Dedicate oneself fully to Hashem's service
              with purity of intent. <br />
              <br />
